...
public class MainActivity extends AppCompatActivity {
    ...
    public void sumaonClick(View view) {
        try{
            ...
            et_resultado.setText("Error no se puede sumar");
        }
    ...
    public void multiplicaciononClick(View view) {
        try{
            ...
            et_resultado.setText("Error no se puede multiplicar");
        }
    ...
    public void divisiononClick(View view) {
        try{
            ...
            et_resultado.setText("Error no se puede dividir");
        }
    ...
    public void moduloonClick(View view) {
        try{
            ...
            et_resultado.setText("Error no se puede sacar el modulo");
        }
